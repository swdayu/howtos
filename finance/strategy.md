...
以持续成长和低估的基本原则进行量化选股：考虑成长/估值/动量/资本回报率ROIC/股息率/流通市值来选择几十只股票建立股票池
- 五年每季度净利润稳定连续增长，净利润增长至少15%，最好25%以上，但100%以上的不考虑
...
股池股票买入标准: PE小于30、PEG小于1的股票等权不重仓持有，并采用如下买卖策略进行操作
```c
