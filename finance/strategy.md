...
开网时间：指数跌破双均（五年和十年平均估值）开始撒出第一网  
原始筹码：拿出30份资金，每跌5%买一次，可抵御的下跌幅度为55%，由于是均值之后才开网，因此该策略在均值跌破后再跌55%也是安全的  
买入策略：每跌5%买一次，越跌买越多，在55%的跌幅区间内，可以买4个1份，4个2份，4个4份，如下：  
```
...
0.25         (4N 28N)          [ ]
```
卖出策略：上涨到上一格价位卖出成本，保留利润，不同的是2N和4N都只卖一半成本，另一半成本留作长期仓位  
长期仓位：长期仓位是持有不动的仓位，除非极度高估否则绝不卖出，长期仓位包括了每次卖出保留的利润，以及深层次网格留出的一半成本  
跌幅破位：如果跌幅真的超过了55%怎么办呢，此时该指数已极具价值，因此只需卖入作为长期仓位即可，此时还是每格买四份  
季度平衡：季度平衡是针对除去长期仓位后的剩余仓位（因为长期仓位无需卖出），每季度平衡一次使市值维持与成本相等  
